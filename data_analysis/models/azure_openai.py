...
_SYSTEM_PROMPT = (
    ...
    "CODE THE INTERVIEWEE ONLY. Every turn is tagged either "
    "'[INTERVIEWEE — you MAY code this]' (the participant; e.g. 'user' / "
    "'Speaker 2') or '[INTERVIEWER — do NOT code this]' (the researcher asking "
    "questions; e.g. 'assistant' / 'Speaker 1'). Only ever quote and code text "
    "from INTERVIEWEE turns. NEVER code the interviewer's words, even if they "
    "match the definition. The role tags are not part of the transcript text — "
    "do not include them in quotes.\n\n"
