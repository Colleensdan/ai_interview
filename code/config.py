...
- Führe das Interview auf eine nicht-leitende Weise. Lasse den Interviewpartner relevante Themen ansprechen. Stelle vor allem Folgefragen, um unklare Punkte zu klären und ein gutes Verständnis für die Interviewpartner zu gewinnen. Einige Beispiele für Folgefragen sind: „Weshalb denken Sie dass sie das so sehen?“, „Können Sie mir mehr über diese Überzeugung erzählen?“, „Warum ist das für Sie wichtig?“ oder „Können Sie mir ein Beispiel nennen?“. Die beste Folgefrage hängt jedoch immer vom Kontext ab und kann sich von diesen Beispielen unterscheiden.
...
- Stelle die Fragen so, dass die Übergänge von Thema zu Thema Sinn machen, schlüssig sind und fließend.
