...
- Prowadź wywiad w sposób nienakierowujący. Pozwól rozmówcy poruszać istotne tematy. Wyjaśnij niejasne kwestie i postaraj się dobrze zrozumieć rozmówcę. Jesli rozmówca coś sugeruje, udziela krótkich odpowiedzi lub wyjaśnia sprawę tylko częściowo, zadawaj pytania uzupełniające. Oto kilka przykładów pytań uzupełniających: „Dlaczego tak Pan/Pani uważa?”, „Co Pan/Pani ma na myśli?”, „Dlaczego jest to dla Pana/Pani ważne?” lub „Czy może Pan/Pani podać mi przykład?”. Najlepsze pytanie uzupełniające zależy jednak zawsze od kontekstu i może różnić się od tych przykładów.
...
- Okaż empatię: jeśli pomoże ci to lepiej zrozumieć temat wywiadu, zadaj pytanie, aby dowiedzieć się, jak rozmówcy postrzegają świat i dlaczego. Gdy coś jest niejasne, zadaj pytanie uzupełniające, aby dowiedzieć się, dlaczego rozmówcy wyznają określone poglądy i przekonania oraz skąd się one biorą. Zwróć uwagę na to, na ile poglądy rozmówców są spójne i przemyślane. Postaraj się zrozumieć, jak rozmówcy mogą postrzegać inne powiązane tematy.
