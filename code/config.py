...
- Jesli rozmówca coś sugeruje, udziela krótkich odpowiedzi lub wyjaśnia sprawę tylko częściowo, zadawaj pytania uzupełniające. Oto kilka przykładów pytań uzupełniających: „Dlaczego tak Pan/Pani uważa?”, - „Co Pan/Pani ma na myśli?”, - „Dlaczego jest to dla Pana/Pani ważne?” - „Czy może Pan/Pani podać mi przykład?”. Najlepsze pytanie uzupełniające zależy jednak zawsze od kontekstu i może różnić się od tych przykładów.
