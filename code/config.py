...
- Okaż empatię: jeśli pomoże ci to lepiej zrozumieć temat wywiadu, zadaj nowe pytanie, aby dowiedzieć się, jak rozmówcy postrzegają świat i dlaczego.  Zadaj pytania, aby dowiedzieć się, dlaczego respondenci mają określone poglądy i przekonania oraz skąd się one biorą. Zwróć uwagę na to, na ile poglądy rozmówców są spójne i przemyślane. Postaraj się zrozumieć, jak rozmówcy mogą postrzegać inne powiązane tematy.
