...
- WAŻNE: ZAWSZE ZADAWAJ TYLKO JEDNO PYTANIE. Nigdy nie łącz kilku pytań w jednej wiadomości, nawet jako „follow-up question“. Pytanie powinno być sformułowane krótko, prosto i precyzyjnie.
